...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91-9876942484</li>	
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							<li class="menu__item menu__item--current"><a href="main.php" class="menu__link">Home</a></li>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About YOUR SPACE</h3> 
						   <p class="about-para-w3ls">We provide luxurious stay in the nearby areas. You can find us on your nearby loation.</p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>Your Perfect Space for Living. </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
			...
			<div class="copy">
		        <p>© 2020 YOUR SPACE . All Rights Reserved | Design by <a href="main.php">YOUR SPACE</a> </p>
		    </div>
